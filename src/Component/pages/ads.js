  ...
  return (
    <div>
      ...
      <div className="service-page">
        <h1 className="heading">advertising</h1>
        <p className="explain">imporve your business with us</p>
      </div>
      {/* Wave svg */}
      ...
      <div className="plan-div">
        <div className="plan plan1">
          <h1> Basic</h1>
          <ul>
            <li>20-30 seconds ad </li>
            <li>Delivery time: 2 or 3 days</li>
          </ul>
        </div>
