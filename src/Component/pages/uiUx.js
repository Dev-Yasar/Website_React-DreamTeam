  ...
  return (
    <div>
      <div className="service-page">
        <h1 className="heading"> UI & UX Designing</h1>
        <p className="explain">
          we Designing awesome ui for your apps & websites
        </p>
      </div>
      ...
      <div className="plan-div">
        <div className="plan plan1">
          ...
          <ul>
            ...
            <li>Delivery time: 4 or 5 days</li>
          </ul>
        </div>
        ...
        <div className="plan plan2">
          ...
          <ul>
            <li>3 Sample UI</li>
            <li>15 Revises for correction</li>
        ...
        <div className="plan plan3">
          ...
          <ul>
            <li>5 Sample UI</li>
            <li>
              <i class="fas fa-infinity"></i> Revises for correction
            </li>
            <li>your custom deadline</li>
          </ul>
        </div>
      </div>
